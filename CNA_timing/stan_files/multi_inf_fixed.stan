\\pooled model for synthetic data with fixed switching rates
...
parameters{
    array[J] real<lower=0> kappa;               
    array[J] real<lower=0,upper=1> eta;          
    array[J] real<lower=0,upper=1> delta;        
...
transformed parameters {
    ...
    array[J, K+1] real<lower=0.001> a;            
    array[J, K+1] real<lower=0.001> b;         
