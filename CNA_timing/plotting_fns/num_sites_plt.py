...
folder_path_loh = '/Volumes/files/az/pool/loh/num_sites'
folder_path_tri = '/Volumes/files/az/pool/tri/num_sites'
folder_path_tet = '/Volumes/files/az/pool/tet/num_sites'
...
plt.xticks(
    ...
    labels=[f"{int(num)}\n({int(total)})" for num, total in zip(tri_num_sites_sorted, tri_total_sites)],
    fontsize=13
)

plt.xlabel('Number of fCpG Sites\n(Total fCpG sites)', fontsize=14.5)
...
plt.savefig('/Users/finnkane/Desktop/Plots/sim/num_sites.png', dpi=300, bbox_inches="tight")
plt.show()
